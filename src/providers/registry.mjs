...
export const BUILTIN_PROVIDERS = {
  xai: {
    ...
    models: [
      ...
      { id: "grok-4-fast-reasoning", name: "Grok 4 Fast Reasoning (retired→4.3)", context: 2000000, tags: ["reasoning", "fast", "retired"] },
      { id: "grok-4-fast-non-reasoning", name: "Grok 4 Fast Non-reasoning (retired)", context: 2000000, tags: ["fast", "retired"] },
      { id: "grok-4.1-fast", name: "Grok 4.1 Fast", context: 1000000, tags: ["fast"] },
      // Legacy / vision
      { id: "grok-3", name: "Grok 3 (retired→4.3)", context: 131072, tags: ["legacy", "retired"] },
      { id: "grok-3-mini", name: "Grok 3 Mini (retired)", context: 131072, tags: ["legacy", "fast", "retired"] },
